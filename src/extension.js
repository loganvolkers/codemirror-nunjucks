...
nunjucks();
// CodeMirror.defineExtension('enableNunjucksTags', 

function showModal(...args){
    console.log("Show modal", args);
...
export default function Extension(handleRender) {
  if (!handleRender) {
  ...
  const debouncedRefreshFn = debounce(refreshFn, 200);
